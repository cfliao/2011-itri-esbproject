...
--
-- Definition of table `bannerdata`
--
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY  (`orderid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='cadastro de pedidos';
...
INSERT INTO `orders` (`orderid`,`userid`,`orderdate`,`shipaddr1`,`shipaddr2`,`shipcity`,`shipstate`,`shipzip`,`shipcountry`,`billaddr1`,`billaddr2`,`billcity`,`billstate`,`billzip`,`billcountry`,`courier`,`totalprice`,`billtofirstname`,`billtolastname`,`shiptofirstname`,`shiptolastname`,`creditcard`,`exprdate`,`cardtype`,`locale`) VALUES 
 (8,'j2ee','2007-03-01','901 San Antonio Road','MS UCUP02-206','Palo Alto','CA','94303','USA','901 San Antonio Road','MS UCUP02-206','Palo Alto','CA','94303','USA','UPS','217.00','ABC','XYX','ABC','XYX','999 9999 9999 9999','12/03','Visa','CA'),
 (9,'j2ee','2011-03-09','901 San Antonio Road','MS UCUP02-206','Palo Alto','CA','94303','USA','901 San Antonio Road','MS UCUP02-206','Palo Alto','CA','94303','USA','UPS','5.50','ABC','XYX','ABC','XYX','999 9999 9999 9999','12/03','Visa','CA');
